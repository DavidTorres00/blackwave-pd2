...
m_log_error("BW_PROBE", "auto_ingame: start")

ppr_require("Trainer/addons/weap_fix1")
m_log_error("BW_PROBE", "auto_ingame: weap_fix1 done")

ppr_dofile('Trainer/Setup/auto_config')
m_log_error("BW_PROBE", "auto_ingame: auto_config done")
...
m_log_error("BW_PROBE", "auto_ingame: end")