...
backuper:hijack('MenuNodeMainGui._add_version_string', function(o, self, ... )
	local r = o(self, ...)
		self._version_string:set_text(string.format(" Blackwave Reborn Trainer! \n Version: %s \n Game Version: %s \n SuperBLT Version: %s \n by %s ", ppr_config.const_version or '0', Application:version(), ppr_config.const_blt_version or 'X', ppr_config.const_creator or 'SULONG'))
